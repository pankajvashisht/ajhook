            ...
            <h1>Shop Details</h1>
             <Nav tabs className="separator-tabs ml-0 mb-5">
              ...
              <TabPane tabId="1">
                <Row>
                  <Colxx xxs="12" lg="4" className="mb-4 col-left">
                    <Card className="mb-4">
                      ...
                      <SingleLightbox thumb={driverDetails.profile ? driverDetails.profile:'/assets/img/profile-pic.jpg'} large={driverDetails.profile ? driverDetails.profile:'/assets/img/profile-pic.jpg'} className="card-img-top" />
				...
				<hr />
				<div>
				<b> Phone </b> : {driverDetails.phone_code}{driverDetails.phone}
				</div>
				<hr />
				<div>
				...
				<div>
					<b> Status </b> : <StatusUpdate
											table="users"
											onUpdate={(data) => driverDetails.status = (driverDetails.status === 1)?0:1}
											data={driverDetails}
										/>
				</div>
				<hr />
                            ...
                            <Colxx xxs="12" lg="12" xl="12" className="mb-12" >
                              ...
                              <Card>
                               ...
                               <CardTitle>Licence</CardTitle>
                                    <CardImg style={ {   height: "400px"}} top alt={driverDetails.licence} src={driverDetails.licence} />
                               </CardBody>     
                              </Card> 
